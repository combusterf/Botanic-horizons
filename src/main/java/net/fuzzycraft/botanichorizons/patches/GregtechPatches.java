...
public class GregtechPatches {
    public static void applyPatches() {
        ...
        for (int i = 0; i < 16; i++) {
            ...
            // petals
            GT_ModHandler.addShapelessCraftingRecipe(powder, GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[] {
                ToolDictNames.craftingToolMortar, petal
            });
            GT_ModHandler.addPulverisationRecipe(petal, powder);

            // flowers
            GT_ModHandler.addShapelessCraftingRecipe(powder, GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[] {
                ToolDictNames.craftingToolMortar, flower
            });
        ...
        for (int i = 0; i < 16; i++) {
            GT_ModHandler.addCompressionRecipe(
                    new ItemStack(ModItems.petal, 9, i), new ItemStack(ModBlocks.petalBlock, 1, i));
            GT_ModHandler.addExtractionRecipe(
                    new ItemStack(ModBlocks.petalBlock, 1, i), new ItemStack(ModItems.petal, 9, i));
        }

        // Petals from flowers
        for (int i = 0; i < 16; i++) {
            GT_ModHandler.addExtractionRecipe(
                    new ItemStack(ModBlocks.flower, 1, i), new ItemStack(ModItems.petal, 2, i));
        ...
        addSlabRecipe(
                new ItemStack(ModFluffBlocks.livingrockSlab, 2), new ItemStack(ModBlocks.livingrock, 1), 1, 16, 80);
        addSlabRecipe(
                new ItemStack(ModFluffBlocks.prismarineSlab, 2), new ItemStack(ModBlocks.prismarine, 1), 1, 16, 80);
        addSlabRecipe(new ItemStack(ModFluffBlocks.reedSlab, 2), new ItemStack(ModBlocks.reedBlock, 1), 1, 16, 80);
        addSlabRecipe(
                new ItemStack(ModFluffBlocks.shimmerrockSlab, 2), new ItemStack(ModBlocks.shimmerrock, 1), 1, 16, 80);
        addSlabRecipe(
                new ItemStack(ModFluffBlocks.shimmerwoodPlankSlab, 2),
                new ItemStack(ModBlocks.shimmerwoodPlanks, 1),
                1,
                16,
                80);
        ...
        addSlabRecipe(
                new ItemStack(ModFluffBlocks.netherBrickSlab, 2),
                new ItemStack(ModBlocks.customBrick, 1, Constants.BRICK_META_HELL),
                1,
                16,
                80);
        addSlabRecipe(
                new ItemStack(ModFluffBlocks.soulBrickSlab, 2),
                new ItemStack(ModBlocks.customBrick, 1, Constants.BRICK_META_SOUL),
                1,
                16,
                80);
        addSlabRecipe(
                new ItemStack(ModFluffBlocks.snowBrickSlab, 2),
                new ItemStack(ModBlocks.customBrick, 1, Constants.BRICK_META_FROST),
                1,
                16,
                80);
        addSlabRecipe(
                new ItemStack(ModFluffBlocks.tileSlab, 2),
                new ItemStack(ModBlocks.customBrick, 1, Constants.BRICK_META_ROOF),
                1,
                16,
                80);
        ...
        for (int i = 0; i < 4; i++) {
            addSlabRecipe(
                    new ItemStack(ModFluffBlocks.stoneSlabs[i + 0], 2),
                    new ItemStack(ModFluffBlocks.stone, 1, i + 0),
                    1,
                    16,
                    80);
            addSlabRecipe(
                    new ItemStack(ModFluffBlocks.stoneSlabs[i + 4], 2),
                    new ItemStack(ModFluffBlocks.stone, 1, i + 8),
                    1,
                    16,
                    80);
        }
        ...
        for (int i = 0; i < ModFluffBlocks.pavementStairs.length; i++)
            addSlabRecipe(
                    ...
                    new ItemStack(ModFluffBlocks.pavement, 1, i),
                    1,
                    16,
                    80);

        // Blocks to either planks or slabs
        ModCraftingRecipes.recipeLivingwoodDecor1 = addSlabRecipe(
                new ItemStack(ModBlocks.livingwood, 4, Constants.LIVINGWOOD_META_PLANK),
                new ItemStack(ModBlocks.livingwood, 1, Constants.LIVINGWOOD_META_BLOCK),
                2,
                16,
                200);
        addSlabRecipe(
                new ItemStack(ModBlocks.dreamwood, 4, Constants.LIVINGWOOD_META_PLANK),
                new ItemStack(ModBlocks.dreamwood, 1, Constants.LIVINGWOOD_META_BLOCK),
                2,
                16,
                200);
        addSlabRecipe(
                new ItemStack(ModFluffBlocks.livingwoodSlab, 2),
                new ItemStack(ModBlocks.livingwood, 1, Constants.LIVINGWOOD_META_BLOCK),
                1,
                16,
                80);
        addSlabRecipe(
                new ItemStack(ModFluffBlocks.livingwoodPlankSlab, 2),
                new ItemStack(ModBlocks.livingwood, 1, Constants.LIVINGWOOD_META_PLANK),
                1,
                16,
                80);
        addSlabRecipe(
                new ItemStack(ModFluffBlocks.dreamwoodSlab, 2),
                new ItemStack(ModBlocks.dreamwood, 1, Constants.LIVINGWOOD_META_BLOCK),
                1,
                16,
                80);
        addSlabRecipe(
                new ItemStack(ModFluffBlocks.dreamwoodPlankSlab, 2),
                new ItemStack(ModBlocks.dreamwood, 1, Constants.LIVINGWOOD_META_PLANK),
                1,
                16,
                80);
        ModCraftingRecipes.recipeLivingwoodTwig = addSlabRecipe(
                new ItemStack(ModItems.manaResource, 2, Constants.MANARESOURCE_META_TWIG_WOOD),
                new ItemStack(ModBlocks.livingwood, 1, Constants.LIVINGWOOD_META_PLANK),
                2,
                16,
                200);
        ModCraftingRecipes.recipeDreamwoodTwig = addSlabRecipe(
                new ItemStack(ModItems.manaResource, 2, Constants.MANARESOURCE_META_TWIG_DREAM),
                new ItemStack(ModBlocks.dreamwood, 1, Constants.LIVINGWOOD_META_PLANK),
                2,
                16,
                200);
        addStairs(
                ModFluffBlocks.livingrockStairs,
                new ItemStack(ModBlocks.livingrock, 1, Constants.LIVINGSTONE_META_BLOCK));
        addStairs(
                ModFluffBlocks.livingrockBrickStairs,
                new ItemStack(ModBlocks.livingrock, 1, Constants.LIVINGSTONE_META_BRICK));
        addStairs(
                ModFluffBlocks.livingwoodStairs,
                new ItemStack(ModBlocks.livingwood, 1, Constants.LIVINGWOOD_META_BLOCK));
        addStairs(
                ModFluffBlocks.livingwoodPlankStairs,
                new ItemStack(ModBlocks.livingwood, 1, Constants.LIVINGWOOD_META_PLANK));
        addStairs(
                ModFluffBlocks.dreamwoodStairs, new ItemStack(ModBlocks.dreamwood, 1, Constants.LIVINGWOOD_META_BLOCK));
        addStairs(
                ModFluffBlocks.dreamwoodPlankStairs,
                new ItemStack(ModBlocks.dreamwood, 1, Constants.LIVINGWOOD_META_PLANK));
        addSlabRecipe(
                new ItemStack(ModFluffBlocks.dreamwoodPlankSlab, 2),
                new ItemStack(ModBlocks.dreamwood, 1, Constants.LIVINGWOOD_META_PLANK),
        ...
        // Cracked blocks
        ModCraftingRecipes.recipeLivingrockDecor3 = addHammerRecipe(
                new ItemStack(ModBlocks.livingrock, 1, Constants.LIVINGSTONE_META_CRACKED),
                new ItemStack(ModBlocks.livingrock, 1, Constants.LIVINGSTONE_META_BRICK));

        // Quartzes and derivatives
        ModCraftingRecipes.recipeDarkQuartz = addQuartzRecipes(
                Constants.QUARTZ_META_DARK,
                new ItemStack(Items.coal, 1, Short.MAX_VALUE),
                ModFluffBlocks.darkQuartz,
                ModFluffBlocks.darkQuartzStairs,
                ModFluffBlocks.darkQuartzSlab);
        addQuartzRecipes(
                Constants.QUARTZ_META_MANA,
                null,
                ModFluffBlocks.manaQuartz,
                ModFluffBlocks.manaQuartzStairs,
                ModFluffBlocks.manaQuartzSlab);
        ModCraftingRecipes.recipeBlazeQuartz = addQuartzRecipes(
                Constants.QUARTZ_META_BLAZE,
                new ItemStack(Items.blaze_powder),
                ModFluffBlocks.blazeQuartz,
                ModFluffBlocks.blazeQuartzStairs,
                ModFluffBlocks.blazeQuartzSlab);
        ModCraftingRecipes.recipesLavenderQuartz = Collections.singletonList(addQuartzRecipes(
                Constants.QUARTZ_META_LAVENDER,
                "flowerLavender",
                ModFluffBlocks.lavenderQuartz,
                ModFluffBlocks.lavenderQuartzStairs,
                ModFluffBlocks.lavenderQuartzSlab));
        ModCraftingRecipes.recipeRedQuartz = addQuartzRecipes(
                Constants.QUARTZ_META_RED,
                "dustRedstone",
                ModFluffBlocks.redQuartz,
                ModFluffBlocks.redQuartzStairs,
                ModFluffBlocks.redQuartzSlab);
        addQuartzRecipes(
                Constants.QUARTZ_META_ELVEN,
                null,
                ModFluffBlocks.elfQuartz,
                ModFluffBlocks.elfQuartzStairs,
                ModFluffBlocks.elfQuartzSlab);
        ModCraftingRecipes.recipeSunnyQuartz = addQuartzRecipes(
                Constants.QUARTZ_META_SUNNY,
                new ItemStack(Blocks.double_plant, 1, 0),
                ModFluffBlocks.sunnyQuartz,
                ModFluffBlocks.sunnyQuartzStairs,
                ModFluffBlocks.sunnyQuartzSlab);
        ...
        for (int i = 0; i < 32; i++) {
            ...
            CraftingPatches.addOreDictRecipe(
                    output,
                    "SPS",
                    "PSP",
                    "SPS",
                    'P',
                    new ItemStack(choice, 1, i % 16),
                    'S',
    ...
    private static void addMixerRecipe(ItemStack output, int volt, int ticks, ItemStack... input) {
        GT_Recipe.GT_Recipe_Map.sMixerRecipes.addRecipe(
                true, input, new ItemStack[] {output}, null, null, null, null, ticks, volt, 0);
    }
    ...
    private static IRecipe addSlabRecipe(ItemStack output, ItemStack input, int circuit, int volt, int ticks) {
        ...
        if (volt < 32 && (output.stackSize % 2) == 0) {
            ...
            GT_ModHandler.addCraftingRecipe(half_output, new Object[] {r1, r2, 'R', input});
            return new ShapedOreRecipe(half_output, r1, r2, 's', ToolDictNames.craftingToolSaw.name(), 'R', input);
        } else return null;
    }

    public static IRecipe addHammerRecipe(ItemStack output, ItemStack input) {
        GT_Recipe.GT_Recipe_Map.sHammerRecipes.addRecipe(
                true, new ItemStack[] {input}, new ItemStack[] {output}, null, null, null, null, 32, 4, 0);
        GT_ModHandler.addCraftingRecipe(output, new Object[] {"h", "R", 'R', input});
        return new ShapedOreRecipe(output, "h", "R", 'R', input, 'h', ToolDictNames.craftingToolHardHammer.name());
    }

    public static IRecipe addQuartzRecipes(
            int quartzMeta, @Nullable Object ingredient, Block block, Block stairs, Block slab) {
        ...
        for (int i = 0; i < 3; i++) {
            GT_ModHandler.addExtractionRecipe(
                    new ItemStack(block, 1, i), new ItemStack(ModItems.quartz, 4, quartzMeta));
        }
        ...
        if (ingredient != null) {
            if (quartzMeta != Constants.QUARTZ_META_DARK) {
                GameRegistry.addRecipe(new ShapedOreRecipe(
                        new ItemStack(ModItems.quartz, 8, quartzMeta),
                        "QQQ",
                        "QCQ",
                        "QQQ",
                        'Q',
                ...
                GT_ModHandler.addAlloySmelterRecipe(
                        ...
                        new ItemStack(ModItems.quartz, 8),
                        400,
                        16,
                        false);
                GT_ModHandler.addAlloySmelterRecipe(
    ...
    public static void addGlassPane(Block paneBlock, Block inputBlock) {
        ...
        GT_ModHandler.addCraftingRecipe(
                ...
                new Object[] {"s", "G", 'G', new ItemStack(inputBlock, 1), 's', ToolDictNames.craftingToolSaw.name()});
    }
    ...
    public static void addStairs(Block stairsBlock, Object baseBlock, int flags) {
        if ((flags & 1) > 0)
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(new ItemStack(stairsBlock, 4), "  Q", " QQ", "QQQ", 'Q', baseBlock)
                            .setMirrored(false));
        if ((flags & 2) > 0)
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(new ItemStack(stairsBlock, 4), "Q  ", "QQ ", "QQQ", 'Q', baseBlock)
