...
public class ThaumcraftPatches {
    public static void applyPatches() {
        ...
        new ResearchBuilder("ALTAR")
                ...
                .setDifficulty(3)
                .setResearchAspects(
                        Aspect.PLANT, Aspect.EXCHANGE, Aspect.MAGIC, Aspect.AURA, Aspect.ELDRITCH, Aspect.MECHANISM)
                .addSingleTextPage()
                ...
                .apply(builder -> {
                    ...
                    ItemStack pearl =
                            OreDictionary.getOres(LibOreDict.MANA_PEARL).get(0);
                    ItemStack prismarine =
                            OreDictionary.getOres(LibOreDict.PRISMARINE_SHARD).get(0);
                    ItemStack manasteel =
                            OreDictionary.getOres(LibOreDict.MANA_STEEL).get(0);
                    builder.addInfusionRecipe(
                            new AspectList()
                                    .add(Aspect.PLANT, 64)
                                    .add(Aspect.CRAFT, 32)
        ...
        new ResearchBuilder("TERRASTEEL")
                ...
                .apply(builder -> {
                    ...
                    ItemStack gemTier = new ItemStack(
                            (Item) Item.itemRegistry.getObject("dreamcraft:item.EngravedDiamondCrystalChip"));
        ...
        new ResearchBuilder("ALFHEIM")
                ...
                .setDifficulty(3)
                .setResearchAspects(
                        Aspect.EARTH, Aspect.PLANT, Aspect.ELDRITCH, Aspect.AURA, Aspect.TRAVEL, Aspect.SENSES)
                .addTextPages(0, 1)
                ...
                .apply(builder -> {
                    ...
                    ItemStack gemIV =
                            new ItemStack((Item) Item.itemRegistry.getObject("dreamcraft:item.EngravedEnergyChip"));
        ...
        new ResearchBuilder("ALCHEMY_CATALYST")
                ...
                .addCraftingRecipe(
                        ...
                        "SIS",
                        'S',
                        new ItemStack(ModBlocks.livingrock, 1, Constants.LIVINGWOOD_META_BLOCK),
                        'C',
                        Constants.thaumcraftConstruct(),
                        'I',
        ...
        new ResearchBuilder("CONJURATION_CATALYST")
                ...
                .setDifficulty(3)
                .setResearchAspects(
                        Aspect.WATER, Aspect.EXCHANGE, Aspect.MAGIC, Aspect.GREED, Aspect.CRAFT, Aspect.VOID)
                .addSingleTextPage()
        ...
        new ResearchBuilder("GAIA_PYLON")
                ...
                .setWarp(5)
                .setResearchAspects(
                        Aspect.ELDRITCH, Aspect.GREED, Aspect.MIND, Aspect.CRYSTAL, Aspect.DARKNESS, Aspect.TRAP)
                .addSingleTextPage()
                .setDependencies("ALFHEIM")
                .setExternalDependencies("ELDRITCHMINOR")
                .apply(builder -> {
                    ItemStack pinkGem =
                            new ItemStack(ModItems.manaResource, 1, Constants.MANARESOURCE_META_DRAGONSTONE);
                    ItemStack blackPlate =
                            OreDictionary.getOres("plateNaquadah").get(0);
                    ItemStack voidCap = new ItemStack((Item) Item.itemRegistry.getObject("Thaumcraft:WandCap"), 1, 7);
                    ItemStack pinkChip = new ItemStack(
                            (Item) Item.itemRegistry.getObject("dreamcraft:item.EngravedManyullynCrystalChip"));
                    builder.addInfusionRecipe(
                            new AspectList()
                                    .add(Aspect.ELDRITCH, 64)
                                    .add(Aspect.TRAP, 64)
        ...
        new ResearchBuilder("BREWERY")
                ...
                .apply(builder -> {
                    ...
                    ItemStack orangeChip =
                            new ItemStack((Item) Item.itemRegistry.getObject("dreamcraft:item.EngravedGoldChip"));
                    builder.addInfusionRecipe(
                            new AspectList()
        ...
        new ResearchBuilder("TERRASTEEL_SWORD")
                ...
                .apply(builder -> {
                    ...
                    ItemStack gem1 =
                            OreDictionary.getOres("gemFlawlessGreenSapphire").get(0);
        ...
        new ResearchBuilder("LAPUTA")
                ...
                .apply(builder -> {
                    ...
                    ItemStack ingot =
                            OreDictionary.getOres(LibOreDict.TERRA_STEEL).get(0);
                    ItemStack crystal =
                            new ItemStack((Item) Item.itemRegistry.getObject("Thaumcraft:blockCrystal"), 1, 0);
                    ItemStack chip = new ItemStack(
                            (Item) Item.itemRegistry.getObject("dreamcraft:item.EngravedQuantumChip"), 1, 0);
                ...
                .apply(builder -> {
                    for (int level = 1; level < 20; level++) { // note: tooltips add +1
                        ...
                        for (ItemStack ingot : ingots) {
                            ...
                            builder.addInfusionRecipe(
                                    new AspectList()
                                            .add(Aspect.WEATHER, 8 * level)
                                            .add(Aspect.AIR, 32 * level)
                                            .add(Aspect.EARTH, 8 * level)
                                            .add(Aspect.TRAVEL, 24 * level),
