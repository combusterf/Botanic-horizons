...
public class BlockAdvancedConjurationPool extends BlockModContainer<TileAdvancedConjurationPool> implements IWandHUD, IWandable, ILexiconable, IBlockTooltip {
    ...
    public void registerBlockIcons(IIconRegister register) {
        this.iconPrimary = register.registerIcon(BH_ICON_PREFIX + "quartzGreenTop");
        this.iconSecondary = register.registerIcon(BH_ICON_PREFIX + "quartzGreenSide");
    }
