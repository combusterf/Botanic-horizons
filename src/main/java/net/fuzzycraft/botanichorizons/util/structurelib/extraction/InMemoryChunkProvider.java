...
public class InMemoryChunkProvider implements IChunkProvider{
    private final World world;
    private final LongHashMap loadedChunks = new LongHashMap();

    public InMemoryChunkProvider(World world) {
        this.world = world;
    }
