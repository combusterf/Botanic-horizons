package net.fuzzycraft.botanichorizons.util.structurelib.extraction;
...
public class InMemoryWorld extends World {
    ...
    public InMemoryWorld() {
        super(new DummySaveHandler(), "InMemoryWorld", DEFAULT_SETTINGS, new WorldProviderSurface(), new Profiler());
    ...
    protected IChunkProvider createChunkProvider() {
        return new InMemoryChunkProvider(this);
    }
